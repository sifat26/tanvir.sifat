...
export const personal = {
  ...
  resumeUrl: '[ADD_RESUME_URL]', // Replace with a public PDF URL
...
export const about = {
  ...
  paragraphs: [
    ...
    'What ties the work together is a bias toward systems that hold up: reusable component architecture, clean API contracts, and deployments I actually own rather than hand off. I care about the details users never see — loading and error states, data flow, the parts that decide whether software feels solid or brittle.',
    "In parallel I'm pursuing an M.Sc. in ICT at Mawlana Bhashani Science & Technology University, researching applied deep learning for medical image analysis, computer vision, and network intrusion detection. My first international publication was presented at ITSS-IoE 2025 in the United Kingdom.",
    "The throughline: build software that works at scale, and push on what software can do next. I'm looking for teams that value both.",
  ],
};
...
export const experiences = [
  {
    ...
    highlights: [
      'Delivered production Angular and Next.js applications used in live business operations, translating design specs into responsive, accessible interfaces.',
      'Architected reusable component libraries that reduced duplicate UI work across features and improved long-term maintainability.',
      'Integrated REST APIs end-to-end — modeling data flow, handling loading and error states, and coordinating contract changes with backend engineers.',
      'Owned deployment pipelines to IIS Server, configuring builds and troubleshooting environment-specific issues in production.',
      'Collaborated cross-functionally with backend, QA, and product to align technical direction and unblock delivery.',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Built and shipped three production platforms, including Bazarica, a multi-vendor marketplace with payment gateway integration and separate admin, seller, and customer dashboards.',
      'Designed REST APIs and data models covering authentication, product and order management, and search across multi-vendor catalogs.',
      'Deployed to cPanel, VPS, and Azure environments — configuring builds, domains, and SEO for production traffic.',
      'Integrated Google Analytics and SEO optimization to make client storefronts discoverable and measurable.',
      'Worked within collaborative development teams, coordinating frontend and backend contracts to ship on client timelines.',
    ],
...
export const clientProjects = [
  {
    ...
    overview:
      'A live multi-vendor marketplace where sellers list and sell independently, with dedicated admin, seller, and customer experiences. Delivered as a paid client project by a 3-member development team.',
    contributions: [
      'Contributed to multi-vendor marketplace development across frontend and backend',
      'Worked on payment gateway integration for live transactions',
      'Built features across the admin, seller, and customer dashboards',
      'Implemented product and order management flows',
      'Developed search functionality across the catalog',
      'Handled SEO optimization and Google Analytics integration',
      'Supported Azure VPS deployment to production',
    ],
  ...
  },
  {
    ...
    team: 'Built collaboratively with a 3-member development team',
    year: '2024',
    tagline: 'A full-stack storefront built for SEO and production deployment.',
    overview:
      'A paid client e-commerce platform delivered by a 3-member development team — from the Next.js storefront through the API layer to a production VPS deployment.',
    contributions: [
      'Contributed to both frontend and backend development',
      'Worked on REST API integration',
      'Implemented authentication',
      'Handled SEO optimization',
      'Supported VPS deployment to production',
      'Collaborated with the development team throughout',
    ],
    tech: ['Next.js', 'Node.js', 'Express.js'],
    image: null,
  ...
  },
  {
    ...
    team: 'Built collaboratively with a 3-member development team',
    year: '2023',
    tagline: 'A full-stack fashion storefront with authentication and e-commerce features.',
    overview:
      'A paid client e-commerce platform built by a 3-member development team — a React frontend with a Node.js and Express API, deployed to cPanel.',
    contributions: [
      'Contributed to frontend development',
      'Worked on backend API development',
      'Implemented database integration',
      'Built authentication and core e-commerce features',
      'Supported cPanel deployment',
      'Collaborated with the development team throughout',
    ],
