...
export const experiences = [
  {
    ...
    highlights: [
      ...
      'Handled deployment to IIS Server, configuring builds and working through environment-specific issues in production.',
      'Worked day to day with backend, QA, and product to settle technical direction and keep delivery moving.',
    ],
