...
import { Mail, ArrowUpRight, Send, MapPin, Phone } from "lucide-react";
    ...
    <section id="contact" className="py-20 md:py-28" aria-label="Contact">
      <div className="container-page">
        ...
        <p className="mt-5 max-w-3xl text-[16px] md:text-[17px] leading-relaxed text-[var(--text-secondary)]">
          {personal.availability}. If you&apos;re hiring or want to collaborate on
          research, send a message below or reach me directly by email.
        </p>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <span>
                  ...
                  <span className="text-[14.5px] text-[var(--text)] group-hover:underline">
                    {personal.email}
                  </span>
                </span>
              </a>

              <a href={personal.whatsapp} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                <span className="w-10 h-10 grid place-items-center rounded-lg border border-[var(--border)] bg-[var(--bg-subtle)] text-[var(--text)] shrink-0">
          ...
          <div className="lg:col-span-7">
            <form onSubmit={handleSubmit} className="card p-6 md:p-8" noValidate>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-4">
                <button type="submit" disabled={loading} className="btn btn-primary disabled:opacity-60 disabled:cursor-not-allowed">
