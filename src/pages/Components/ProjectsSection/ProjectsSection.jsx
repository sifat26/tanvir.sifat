...
const ProjectsSection = () => {
  return (
    <section id="projects" className="py-20 md:py-28 border-b border-[var(--border)]" aria-label="Selected projects">
      <div className="container-page">
        <SectionHeader
          className="max-w-xl mb-14 md:mb-20"
        ...
        <div className="mb-20 md:mb-28">
          <GroupLabel
            ...
            note="Paid, live in production"
          />
          <p className="-mt-6 mb-10 md:mb-12 max-w-2xl text-[14.5px] leading-relaxed text-[var(--text-secondary)]">
            Paid client projects delivered collaboratively with a 3-member development team. The points
            below highlight my individual contributions within each project.
          </p>
